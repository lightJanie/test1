    ...
    cart.data = {
        html: function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                HTML += '                  value="' + data[i].cart_count +
                    '" /><span class="add">&nbsp;+&nbsp;</span></div>'
                HTML += '           <div class="totle">'
                HTML +=
                    '                                                                     <span>￥</span>'
                HTML += '           <span data-id="' + data[i].id + '" class="totle_information">' + data[i].cart_count * data[i].price +
                    '</span>'
                HTML += '       </div>'
                HTML += '      <div class="del">'
    ...
    $(".reduc").each(function (i, e) {
        $(e).on("click", function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                data : JSON.stringify({'sku_id':sku_id,'cart_count':_v2,'state':'del'}) ,
                success : function(result) {
